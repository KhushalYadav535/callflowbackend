...
exports.TenantEntitlement = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const ConfigLimitsSchema = new mongoose_1.Schema({
    maxAccountsPerDay: Number,
    maxCallsPerDay: Number,
    allowedCapabilities: [String]
}, { _id: false });
const TenantEntitlementSchema = new mongoose_1.Schema({
...
exports.TenantEntitlement = mongoose_1.default.models.TenantEntitlement || mongoose_1.default.model('TenantEntitlement', TenantEntitlementSchema);
