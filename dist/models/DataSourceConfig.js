...
const DataSourceConfigSchema = new mongoose_1.Schema({
    ...
    pullAuthConfig: { type: mongoose_1.Schema.Types.Mixed },
    pullScheduleCron: { type: String },
    fieldMapping: { type: mongoose_1.Schema.Types.Mixed },
...
exports.DataSourceConfig = mongoose_1.default.models.DataSourceConfig || mongoose_1.default.model('DataSourceConfig', DataSourceConfigSchema);
